...
{
  String data = "temp=" + String(temperature) + "&hum=" + String(humidity) + "&rin=" + String(rain) + "&prs=" + String(pressure) + "&wdir=" + String(windDirection) + "&wsp=" + String(windSpeed) + "&slm=" + String(soilMoisture);
  // + "&uva=" + String(uva) + "&uvb=" + String(uvb) + "&uvi=" + String(uvIndex)
  // + "&lgd=" + String(lightningDistance) + "&lgo=" + String(lightningOccurred)

  Serial.println(String(millis()) + ": " + data);
  /*Serial.println(String(millis()) + ":");
  Serial.println("- Temp=" + String(temperature) + ", Humidity=" + String(humidity) + ", Pressure=" + String(pressure));
...
//  Serial.println("- Lightning: Distance=" + String(lightningDistance) + " Occurred:" + String(lightningOccurred));
  Serial.println("- SoilMoisture=" + String(soilMoisture) + " Rain=" + String(rain));*/

  digitalWrite(pinStatLED, HIGH);
  bool result = sendDataToServer(data);
  if (result) {
    digitalWrite(pinStatLED, LOW);
  }
}
